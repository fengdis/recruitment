				...
				<div class="5grid-layout">
					<div class="row">
						...
						<div class="9u mobileUI-main-content" style="margin-left:180px">
							...
							<!-- Content -->
								<form action="${ctx}/com/findCompany.action" method="post">
								...
								<article class="first" style="margin-top: 50px">
									<table width="100%">
										 	<thead>
										 	<tr>
										 		<th align="left" width="60%">公司名称</th>
										 		<th align="left"  width="20%">所在地区</th>
										 	</tr>
										 	</thead>
										 	...
										 	<c:forEach items="${SESSION_PAGE_WEB.list }" var="item">
										 		<tr>
										 		<td align="left"><a href="${ctx}/com/getCompany.action?uid=${item.id}" target="blank">${item.name }</a></td>
										 		<td>${item.area }</td>
										 		</tr>
										 	</c:forEach>
										 	</tbody>
