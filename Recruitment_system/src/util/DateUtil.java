...
public class DateUtil {
	 ...
	 * @return String 字符串时间
	 */
	public static synchronized String getLongTime(Date date){
	    DateFormat longDateFormat = DateFormat.getDateTimeInstance
           		(DateFormat.LONG,DateFormat.LONG); 
	    return longDateFormat.format(date);
	}
	public static synchronized String getFullTime(Date date){
	...
	public static synchronized String getMediumTime(Date date){
