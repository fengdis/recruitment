	...
	<body>
		...
		<!-- Header -->
			...
			<div id="header-wrapper">
				 <jsp:include page="./menu.jsp"><jsp:param value="systype" name="type"/> </jsp:include> 
			</div>
				...
				<div class="5grid-layout">
					<div class="row">
						...
						<div class="9u mobileUI-main-content" style="margin-left:180px">
							...
							<!-- Content -->
								<form action="${ctx}/com/findSysType.action" method="post">
									<input type="hidden" value="${sysTypeType}" name="s_type">
									<input type="text" name="s_name" placeholder="关键字" style="height: 18px;font-size: 14px" size=40/>
								...
								<article class="first" style="margin-top: 50px">
									<table width="100%">
										 	<thead>
										 	<tr>
										 		<th align="left" width="60%">招聘标题</th>
										 	...
										 	<c:forEach items="${SESSION_PAGE_WEB.list }" var="item">
										 		<tr>
										 		<td align="left"><a href="${ctx}/com/getSysType.action?uid=${item.id}" target="blank">${item.name }</a></td>
										 		<td>${item.addDate }</td>
										 		</tr>
										 	</c:forEach>
										 	</tbody>
