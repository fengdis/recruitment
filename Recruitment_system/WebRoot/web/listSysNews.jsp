	...
	<body>
		...
		<!-- Header -->
			...
			<div id="header-wrapper">
				 <jsp:include page="./menu.jsp"><jsp:param value="sysnews" name="type"/> </jsp:include> 
			</div>
				...
				<div class="5grid-layout">
					<div class="row">
						...
						<div class="9u mobileUI-main-content" style="margin-left:180px">
							...
							<!-- Content -->
								<form action="${ctx}/com/findSysNews.action" method="post">
									<input type="text" name="s_name" placeholder="行程名称" style="height: 18px;font-size: 14px" size=20/>
								...
								<article class="first" style="margin-top: 50px">
									<table width="100%">
										 	<thead>
										 	<tr>
										 		<th align="left" width="20%">新闻名称</th>
										 	...
										 	<c:forEach items="${SESSION_PAGE_WEB.list }" var="item">
										 		<tr>
										 		<td align="left"><a href="${ctx}/com/getSysNews.action?uid=${item.id}" target="blank">${item.name }</a></td>
										 		<%-- <td>${item.price }</td> --%>
										 		</tr>
										 	</c:forEach>
										 	</tbody>
