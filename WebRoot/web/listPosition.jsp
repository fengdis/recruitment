	...
	<body>
		...
		<!-- Header -->
			...
			<div id="header-wrapper">
				 <jsp:include page="./menu.jsp"><jsp:param value="position" name="type"/> </jsp:include> 
			</div>
				...
				<div class="5grid-layout">
					<div class="row">
						...
						<div class="9u mobileUI-main-content" style="margin-left:180px">
							...
							<!-- Content -->
								<form action="${ctx}/com/findPosition.action" method="post">
									<input type="text" name="s_point.area" placeholder="输入公司" style="height: 18px;font-size: 14px" size=20/>
									<input type="text" name="s_point.name" placeholder="输入职位" style="height: 18px;font-size: 14px" size=20/>
								...
								<article class="first" style="margin-top: 50px">
									<table width="100%">
										 	...
										 	<tr style="background:#f1f1f1">
										 		<th align="left" width="40%">职位名称</th>
										 		<th align="left" width="40%">所属公司</th>
										 		<th align="left"  width="10%">所在城市</th>
										 		<!-- <th align="left"  width="10%">售价</th>
										 		<th align="left"  width="10%">打折价</th>
										 		<th align="left"  width="10%">团购价</th>
										 		<th align="left"  width="10%">截止日期</th> -->
										 	</tr>
										 	</thead>
										 	...
										 	<c:forEach items="${SESSION_PAGE_WEB.list }" var="item">
										 		<tr>
										 		<td align="left"><a href="${ctx}/com/getPosition.action?uid=${item.id}" target="blank">${item.name }</a></td>
										 		<td align="left"><a href="${ctx}/com/getCompany.action?uid=${item.company.id}" target="blank">${item.company.name }</a></td>
										 		<td>${item.company.area}</td>
