...
<h2 class="contentTitle">修改管理员信息</h2>
<div class="pageContent">
	<form method="post" action="${ctx}/sys/updateSysUser.action" class="pageForm required-validate" enctype="multipart/form-data" onsubmit="return iframeCallback(this)">
		...
		<input name="type" value="${modifybean.type }" type="hidden"/>
		<div class="pageFormContent" layoutH="97">
			<table>
					...
					<tr>
						<td colspan="2"><dl>
							<dt>联系电话：</dt>
							<dd><input name="user.userPhone" value="${modifybean.user.userPhone }" type="text"  class="phone required"/></dd>
							</dl></td>
					</tr>
					<tr>
						<td colspan="2"><dl>
					...
					<tr>
						<td colspan="2"><dl>
							<dt>工作类型：</dt>
							<dd><input name="user.userJob" value="${modifybean.user.userJob }" type="text"  class="required"/></dd>
							</dl></td>
					</tr>
				</table>
		</div>
